...
module SW
  module LASimporter
    module ImporterOptions
      ...
      def get_importer_options_classes()
        @import_options_classes
      end

      def importer_options_horizontal_units()
        @import_options_horizontal_units
      end
      
      def importer_options_vertical_units()
